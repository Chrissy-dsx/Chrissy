...
">
    ...
    top: -10px;
">
                <li><a href="store_buyer.php">Home</a><span>|</span></li>
            </ul>
    ...
    <div class="body_cart">
        ...
        <?php
            $sql="SELECT * FROM cart WHERE username='$usingname'";
            ...
            if(mysqli_num_rows($result)>0){//output
                ...
                echo"
                <a href=\"receipt_buyer.php\"><button class=\"body_cart_buyButton\">Buy</button></a>
                <!--<a href=\"receipt_buyer.php\"><button class=\"body_cart_buyButton\">Buy</button></a>-->
                <a href=\"store_buyer.php\"><button class=\"body_cart_back\">Back</button></a>";

            }
            else{
                echo "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp; Your cart is empty. <a href=\"store_buyer.php\">Go to buy something!</a>";
            }
        ?>
