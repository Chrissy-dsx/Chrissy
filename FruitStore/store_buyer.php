...
">
            ...
            <ul class="header-right">
                ...
                <li style="left:-40px;">User:<?php echo $usingname; ?></li>
    ...
    <div class="nav">
        <div class="wrap">
            ...
            <a href="store_cart.php"><div class="cart"><span class="cart_price">Cart<img src="pic/icon.png" style="width: 24px; height: 24px; position: relative; left: 25px; top:3px;"></span></a>
            </div>
        </div>
    </div>
<div class="pic">
                            ...
                            echo"
                                <div class=\"body_main_fruit_".$i."\">
                                    ...
                                    <div class=\"body_main_fruit_name\">
                                        ".$row["FruitName"]."
                                        <input type=\"submit\" class=\"body_main_fruit_buybutton\" name=\"submit".$row["FruitName"]."\" value=\"buy\">
                                    </div>
